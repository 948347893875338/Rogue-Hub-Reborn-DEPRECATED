...
if not isfile("/Rogue Hub/Configs/Quotes.ROGUEHUB") then 
    writefile("/Rogue Hub/Configs/Quotes.ROGUEHUB", req({ Url = "https://github.com/NomadWithoutAHome/Rogue-Hub/blob/main/Extra/Quotes.ROGUEHUB" }).Body);
end
...
local response = req({
    Url = "https://github.com/NomadWithoutAHome/Rogue-Hub/tree/main/Games" .. game.PlaceId .. ".lua",
    Method = "GET"
})
